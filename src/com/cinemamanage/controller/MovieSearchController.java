...
public class MovieSearchController {
	...
	public String searchByMovieID(@PathVariable String movieID,ModelMap model,HttpSession session){
	...
	public String searchByMovieName(@PathVariable String movieName,ModelMap model,HttpSession session){
	    if(session.getAttribute("currentEmail")==null) {
	        return  "errorPage";
	       }
		MovieRequestDTO req = new MovieRequestDTO();
	...
	public String searchByMovieGenre(@PathVariable String movieGenre,ModelMap model,HttpSession session){
	    if(session.getAttribute("currentEmail")==null) {
	        return  "errorPage";
	       }
		MovieRequestDTO req = new MovieRequestDTO();
	...
	public String searchByMovieAll(@PathVariable String movieId,@PathVariable String movieName,@PathVariable String movieGenre,ModelMap model,HttpSession session){
	    if(session.getAttribute("currentEmail")==null) {
	        return  "errorPage";
	       }
		MovieRequestDTO req = new MovieRequestDTO();
