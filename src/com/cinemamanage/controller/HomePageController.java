...
//			for(DetailTicketResponseDTO s: ticketlist) {
...
//			for(DetailTicketResponseDTO s: ticketlist) {
//			    if(movieSet.add(s.getMovieName())) {
//			        System.out.print(s.getMovieName());
//			        System.out.print(s.getSeatName());
//			    } else {
//			        System.out.print(s.getSeatName());
...
//			}
			...
			model.addAttribute("pendingticketlist", pendingticketlist);
		      ArrayList<DetailTicketResponseDTO> rejectedticketlist = homepageDAO.userPendingTicketTable(dto);
		      model.addAttribute("rejectedticketlist", rejectedticketlist);
//			model.addAttribute("timetableID", ticketlist);
//			model.addAttribute("confirmedTicketList", ticketlist);
