...
public class UserPaymentController {
	...
	public ModelAndView userPayment(ModelMap model,HttpSession session) {
	    if(session.getAttribute("currentUser")==null) {
	        return  new ModelAndView("errorPage","bean",new PaymentBean());
	       }
		
		PaymentMethodDAO dao = new PaymentMethodDAO();
		ArrayList<PaymentMethodResponseDTO>data = dao.selectAllNonDeletedPayment();
		...
		while(it.hasNext()) {
			...
			datalist.put(dto.getPaymentMethodID(),dto.getPaymentMethodName()+"-"+dto.getPaymentMethodPhone());
	...
	public String continuePayment(@ModelAttribute("paymentbean")@Validated PaymentBean bean ,BindingResult rs,ModelMap model,HttpSession session) {
	    if(session.getAttribute("currentUser")==null) {
	        return  "errorPage";
	       }
		System.out.print(bean.getPay()+bean.getPhone());
		if(rs.hasErrors()) {
		...
		if(error==false) {
			...
			//Integer movieIDInt = (Integer) session.getAttribute("movieID");
...
//			for(String s: bean.getSeatANames()) {
//				testlist.add(s);
//				System.out.print(s);
//			}
			//System.out.print(bean.getSeatANames()+","+bean.getSeatBNames());
			//System.out.print(bean.getSeatBNames());
