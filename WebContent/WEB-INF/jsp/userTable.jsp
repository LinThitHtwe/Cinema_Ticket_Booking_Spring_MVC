		...
		<c:forEach items="${userlist}" var="userlist">
			<tr>
				...
				<td style="text-align: center;">
				   <a href="/CinemaTicketBooking/banUser/${userlist.accountID}" class="BanButton" onclick="return confirmBan(event)" style="text-decoration:none; display: inline-block;">Ban</a>
			</tr>
			</c:forEach>
