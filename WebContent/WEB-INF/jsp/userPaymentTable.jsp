...
<link rel="icon" type="image/x-icon"
	href="/CinemaTicketBooking/images/movie.jpg">
<style>
html, body {
	height: 100%;
}
...
<body>
	<div class="container">
		<div class="labelContainer">
			<label class="label">Pending Payment List</label>
		</div>
			...
			<tbody>
				<c:forEach items="${datalist}" var="data">
					<tr>
						...
						<td>
							<button
								onclick="location.href='/CinemaTicketBooking/userPaymentDetails/${data.paymentID}'"
								class="UpdateButton">Details</button>
						</td>
				...
				<c:if test="${pay < 1}">
					<tr>
						<td colspan="5">PaymentMethodList is Empty</td>
					</tr>
				</c:if>
			</tbody>
		</table>
		...
		<div class="labelContainer">
			<label class="label">Confirmed Payment List</label>
		</div>
		<table class="table">
			<tbody>
			<thead>
			...
			<c:if test="${li < 1}">
				<tr>
					<td colspan="5">Confirmed PaymentList is Empty</td>
				</tr>
			</c:if>
		...
		<div class="labelContainer">
			<label class="label">Rejected Payment List</label>
		</div>
		<table class="table">
			<tbody>
			<thead>
			...
			<c:if test="${li < 1}">
				<tr>
					<td colspan="5">Rejected PaymentList is Empty</td>
				</tr>
			</c:if>
