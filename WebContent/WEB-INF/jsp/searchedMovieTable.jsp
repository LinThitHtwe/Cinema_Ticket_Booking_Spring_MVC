...
<c:forEach items="${movielist}" var="movielist">
			<tr>
				...
				<button onclick="location.href='/CinemaTicketBooking/setupUpdateMovie/${movielist.movieID}'" class="UpdateButton" >Update</button>
				<button onclick="location.href='/CinemaTicketBooking/setupDetailMovie/${movielist.movieID}'" class="DetailsButton" >Details</button>
<a href="/CinemaTicketBooking/deleteMovie/${movielist.movieID}" class="DeleteButton" onclick="return confirmDelete(event)" style="text-decoration:none;display: inline-block;">Delete</a>
		...
		<c:if test="${movie < 1}">
		<tr><td colspan="4">Cannot Find the Value in MovieList</td></tr>
		</c:if>
        ...
        <c:forEach items = "${deletedmovielist}" var="deletedmovielist">
             <tr>
				...
				<td style="text-align: center;">
				<button onclick="location.href='setupDetailMovie/${deletedmovielist.movieID}'" class="DetailsButton" >Details</button>
			</tr>
        </c:forEach>
        
        <c:set var="deletedmovie" value="${fn:length(deletedmovielist)}"/>
		<c:if test="${deletedmovie < 1}">
		<tr><td colspan="4">Cannot Find the Value in Deleted Movie List </td></tr>
		</c:if>
