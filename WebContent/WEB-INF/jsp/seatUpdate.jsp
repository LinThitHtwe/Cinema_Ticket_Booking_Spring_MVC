    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td><form:input type="tel"  path="seatPrice" oninput="this.value=this.value.replace(/[^0-9]/g,'');" pattern="[0-9]{4,}" maxlength="5" placeholder="Seat Price" title="Error!! You Cannot put seat price less than 1000MMK"></form:input>
                 </td>
            </tr>
            <tr>
