...
<body>
    <div class="container">
    <h1 class="label">Add Payment Method</h1>
    ...
    <div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><form:input type="text" name="name" path="paymentMethodName" placeholder="Payment Method Name"></form:input>
                 </td>
            </tr>
            <tr>
                <td><label>Phone</label> </td>
                <td><form:input type="tel" name="phone" path="paymentMethodPhone" placeholder="Phone" pattern="09\\d{0,9}" maxlength="11" oninput="this.value=this.value.replace(/[^0-9]/g,'');" title="Phone number should start with 09-"></form:input>
                 </td>
            </tr>
            <tr>
                <td><a type="submit" href="paymentMethodTable" class="CancelButton" style="text-decoration:none">Cancel</a></td>
