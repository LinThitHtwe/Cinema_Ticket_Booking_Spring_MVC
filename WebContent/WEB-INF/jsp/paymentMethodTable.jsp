		...
		<c:forEach items="${paymentmethodlist}" var="paymentmethodlist">
			<tr>
				...
				<button onclick="location.href='setupUpdatePaymentMethod/${paymentmethodlist.paymentMethodID}'" class="UpdateButton" >Update</button>
				 <a href="/CinemaTicketBooking/deletePaymentMethod/${paymentmethodlist.paymentMethodID}" class="DeleteButton" onclick="return confirmDelete(event)" style="text-decoration:none;">Delete</a>
			</tr>
			</c:forEach>
