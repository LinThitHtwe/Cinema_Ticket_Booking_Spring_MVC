...
<body>
    ...
    <form:form action="/CinemaTicketBooking/userUpdate" method="post" modelAttribute="accountBean">
            ...
            <tr>
                ...
                <td><form:input type="email" name="email" path="accountEmail" readonly="true" placeholder="Email"></form:input>
                 </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><form:input style="margin-left:20px;" type="password" name="passowrd" path="confirmPassword" id="confirmpassword-field" placeholder="Confirm Password" ></form:input> 
            ...
            <tr>
                <td><a type="submit" value="Cancel" class="CancelButton" href="/CinemaTicketBooking/"  style="text-decoration:none">Cancel</a></td>
