...
<tr>
    <td>
        <form:label path="phone">User's Phone Number:</form:label>
    </td>
</tr>
<tr>
    <td></td>
...
<tr>
    <td>
        <form:input pattern="09\\d{0,9}" maxlength="11" oninput="this.value=this.value.replace(/[^0-9]/g,'');" title="Phone number should start with 09-" path="phone" class="input-field" type="tel" placeholder="User's Phone Number"/><br>
    </td>
</tr>
